    ...
    chatHistory.forEach(message => {
        ...
        if (message.role === 'user') {
            ...
            if (innerWidth < 380) {
                ...
                userMessageDiv.className = 'd-flex justify-content-end  mb-2 '; // Align to the right
            }
            ...
            if (innerWidth < 380) {
                ...
                userBubble.className = 'bg-secondary rounded p-1 bg-opacity-10'; // Style the bubble
            }
            ...
            if (innerWidth < 380) {
                ...
                responseDiv.className = 'dd-flex justify-content-start  mb-2 rounded  '; // Align to the left
            }
            ...
            if (innerWidth < 380) {
                ...
                assistantBubble.className = 'bg-primary rounded p-1 bg-opacity-10'; // Style the bubble
            }
...
async function submitRequest() {
    ...
    if (innerWidth < 380) {
        ...
        responseDiv.className = 'd-flex justify-content-start  mb-2 rounded '; // Align to the left
    }
...
function appendLastMessage() {
    ...
    if (lastMessage.role === 'user') {
        ...
        if (innerWidth < 380) {
            ...
            bubbleDiv.className = 'd-flex justify-content-end  mb-2';
        }
        ...
        if (innerWidth < 380) {
            ...
            bubbleContent.className = 'bg-secondary rounded p-1 bg-opacity-10';
        }

        bubbleContent.innerHTML = marked.parse(lastMessage.content);
        ...
        if (innerWidth < 380) {
            ...
            bubbleDiv.className = 'dd-flex justify-content-start  mb-2 rounded';
        }
        bubbleContent = document.createElement('div');
        bubbleContent.className = 'bg-primary rounded p-3 bg-opacity-10';
        if (innerWidth < 380) {

            bubbleContent.className = 'bg-primary rounded p-1 bg-opacity-10';
        }
        bubbleContent.innerHTML = marked.parse(lastMessage.content);
    }
...
async function postRequestWithFile(data, selectedFile, responseDiv) {
    ...
    document.getElementById('file-bubble').classList.add('d-none'); // Hide the file bubble
